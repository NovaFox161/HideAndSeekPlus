...
public class BaseCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        if (cmd.getName().equalsIgnoreCase("HideAndSeek") || cmd.getName().equalsIgnoreCase("has") || cmd.getName().equalsIgnoreCase("hasp")) {
            if (sender.hasPermission("hasp.use.command")) {
